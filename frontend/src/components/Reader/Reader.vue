...
import { useScaleAdjust } from './composables/useScaleAdjust';
import { useScrollPage } from './composables/useScrollPage';
...
const { 
 ...
 // 缩放管理
 const { 
  FitWidth, HandleWheel, ZoomIn, ZoomOut, HandleResize,
} = useScaleAdjust(RerenderVisiblePages, readerContainer, pageWidth, emit);

const {
  currentPage, GoToPage, GoToNextPage, GoToPrevPage, ResetLastScrollTop,
